...
public class SaveFxCurvesRestClientImpl extends AbstractRestClient implements SaveFxCurvesRestClient {
    private static final Logger logger = LogManager.getLogger();

    private static final String URL = "/api/fxIndices/%s/curves";
    ...
    public SaveFxCurvesRestClientImpl
            (String host,
             String port,
             String contextPath) {
