...
public class SavePricingLocationsRestClientImpl extends AbstractRestClient implements SavePricingLocationsRestClient {
    ...
    public SavePricingLocationsRestClientImpl
            (String host,
             String port,
             String contextPath) {
