...
public class ValueFxRiskFactorsRestClientImpl extends AbstractRestClient implements ValueFxRiskFactorsRestClient {
    private static final Logger logger = LogManager.getLogger();

    private static final String URL = "/api/fxIndices/riskFactors/valued";
    ...
    public ValueFxRiskFactorsRestClientImpl
            (String host,
             String port,
             String contextPath) {
