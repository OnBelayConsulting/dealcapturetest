 ...
 */
package com.onbelay.dealcapturetest;
...
public class DealCaptureTestApplication implements ApplicationRunner {
	private static final Logger logger = LogManager.getLogger(DealCaptureTestApplication.class);

	
	public static void main(String[] args) {
		
		new SpringApplicationBuilder(DealCaptureTestApplication.class)
