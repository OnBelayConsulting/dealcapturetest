...
public class GeneratePositionsRestClientImpl extends AbstractRestClient implements GeneratePositionsRestClient {
    private static final Logger logger = LogManager.getLogger();

    private static final String URL = "/api/positions/generated";
    ...
    public GeneratePositionsRestClientImpl
            (String host,
             String port,
             String contextPath) {
