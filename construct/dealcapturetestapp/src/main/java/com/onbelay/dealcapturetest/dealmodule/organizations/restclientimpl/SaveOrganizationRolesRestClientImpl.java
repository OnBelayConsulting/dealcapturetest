...
public class SaveOrganizationRolesRestClientImpl extends AbstractRestClient implements SaveOrganizationRolesRestClient {
    ...
    public SaveOrganizationRolesRestClientImpl
            (String host,
             String port,
             String contextPath) {
    ...
    public TransactionResult saveOrganizationRoles(
        ...
        String formattedUrl =URL + organizationId + "/roles";
