...
public class ValuePriceRiskFactorsRestClientImpl extends AbstractRestClient implements ValuePriceRiskFactorsRestClient {
    private static final Logger logger = LogManager.getLogger();

    private static final String URL = "/api/priceIndices/riskFactors/valued";
    ...
    public ValuePriceRiskFactorsRestClientImpl
            (String host,
             String port,
             String contextPath) {
